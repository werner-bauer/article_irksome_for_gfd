...
\revisedB{Here, we describe the stage derivatives formulation of IRKs, where
  ...
  \werner{It seems that this short paragraph is a repetition from above and can be removed!}
...
\subsubsection{Nonlinear solver}
  ...
  (\emph{ie} unpreconditioned) residual falls below this tolerance,
  then the Krylov method iteration is terminated.  This works because
...
For smoothers on each level, we used an additive Schwarz method
(ASM) that
