...
\revisedA{We observe that the IRKs and DIRKs allow for larger timesteps and
 ...
 \begin{tabular}{c}
  \hspace{-1.5cm}\includegraphics[scale=0.62]{Images/gl_imex.pdf}
 \end{tabular}
   \revisedus{
...
\end{figure}
 ...
 \begin{figure}\centering
\begin{tabular}{c}
 \hspace{-1.5cm}\includegraphics[scale=0.62]{Images/rd_imex.pdf}
\end{tabular}
   \revisedus{
...
\revisedus{Hence, it is possible that IRKs will continue to be
  a competitive and viable option} this larger scale setting.
