...
time-to-solution for the 1, 2 and 3 stage schemes than the ARK\checkit{2} IMEX
...
\checkit{which} prevents further speedups from increasing the timestep.
...
\end{tabular}
 \caption{Relative errors of Gauss-Legendre 1-3 and ARK2 IMEX methods
   ...
   \checkit{
   The solid and dashed vertical lines indicate the spatial error between mesh levels L6 and L7
